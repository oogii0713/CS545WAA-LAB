...
<header>
    <nav class="navbar navbar-dark bg-dark">
        <a class="navbar-brand" href="${pageContext.request.contextPath}/">CS545 : : : Calculator MVC2 architecture</a>
        ...
        <div class="row justify-content-md-center">
            <div class="col-4">
                <div class="form-group">
                    ...
                    <input type="text" id="sum" name="sum" value="${param.sum}"  class="form-control" disabled/>
                </div>
            </div>
            <div class="col-4">
                <div class="form-group">
                    <label>Product of num3 and num4</label>
                    <input type="text" id="product" name="product" value="${param.product}" class="form-control" disabled/>
                </div>
            </div>
        </div>
