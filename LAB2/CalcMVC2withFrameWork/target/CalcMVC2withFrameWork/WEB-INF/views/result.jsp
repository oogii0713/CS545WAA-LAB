...
<head>
    ...
    <title>CS545 Lab2 - CalcMVC2 with MVCFramework</title>
</head>
<body>
<header>
    <nav class="navbar navbar-dark bg-dark">
        <a class="navbar-brand" href="calculator">CS545 Lab2 : : : Calculator used MVCFramework jar</a>
...
<main>
    <div class="container">
        <p>&nbsp;</p>
        <h2>LAB2 Calculator with single Controller and Validator</h2>
